...
import { a as ScrollTrigger, g as gsapWithCSS } from "../_libs/gsap.mjs";
...
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Muhammad Waleed, full stack engineer crafting MERN, PHP and AI-powered web platforms from Pakistan."
    }, {
      property: "og:title",
      content: "Muhammad Waleed - Full Stack Engineer"
    }, {
